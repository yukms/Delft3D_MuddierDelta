@ echo off
    ...
    rem 
set argfile=config_dflow2d3d.xml
    ...
    rem
set ARCH=win64
set D3D_HOME=C:\Program Files\Deltares\Delft3D 4.04.01
  rem set D3D_HOME=c:\Program Files\Deltares\Delft3D 4.04.01
...
set MPIPATH=%exedir%
rem set MPIPATH=C:\Program Files\MPICH2\bin
